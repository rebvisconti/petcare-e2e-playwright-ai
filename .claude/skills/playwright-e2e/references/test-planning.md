...
<!-- YOUR PROJECT: Map your application's key user flows -->
...
- Fill pet name, owner, phone
- Select service, size
- Choose date and time
- Submit form
- Verify appointment appears in list

### 3. Edit Appointment Flow
